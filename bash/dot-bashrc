...
# Libero License path
export LIBERO_PATH="/usr/local/microsemi/LiberoSoCv2022.1/Libero/bin"
export PATH="${LIBERO_PATH}:${PATH}"
export LM_LICENSE_FILE="/licenses/License.dat"
...
export GOPATH=/home/mannykoum/go
